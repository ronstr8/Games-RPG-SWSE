package Games::RPG::SWSE::Feat::ArmorProficiencyMedium;
...
sub _build_prerequisites { +{ 'FeatArmorProficiencyLight' => 1 } }
sub _build_name { 'Armor Proficiency (Medium)' }

sub _build_description
{
	return <<EOT;

	You are proficient with medium armor (see Table 8-7: Armor) and can wear it
	without impediment.
...
sub _build_benefit_desc
{
	...
	When you wear medium armor, you take no armor check penalty on attack
...
sub _build_normal_desc
{
	...
	takes a -5 armor check penalty on attack rolls as well as skill checks
